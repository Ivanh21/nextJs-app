...
//   useEffect(() => {
//     const saved = localStorage.getItem("openServices");
//     if (saved) {
//       setOpenIds(JSON.parse(saved));
//     }
//   }, []);

//   // Sauvegarder à chaque changement
//   useEffect(() => {
//     localStorage.setItem("openServices", JSON.stringify(openIds));
//   }, [openIds]);
...
//               openIds.includes(service.id) ? "max-h-full p-4" : "max-h-0 p-0"
